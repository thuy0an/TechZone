...
(category_id, brand_id, code, name, image, description, unit, stock_quantity, import_price, profit_margin, selling_price, status, created_at, updated_at)
VALUES
(1,1,'IP14','iPhone 14 128GB','iphone14.jpg','Điện thoại Apple','Chiếc',22,17000000,15,19550000,'visible',NOW(),NOW()),
(1,2,'S23U','Samsung Galaxy S23 Ultra','s23ultra.jpg','Điện thoại Samsung','Chiếc',14,24000000,12,26880000,'visible',NOW(),NOW()),
(1,9,'XM14','Xiaomi 14 256GB','xiaomi14.jpg','Điện thoại Xiaomi','Chiếc',20,16000000,18,18880000,'visible',NOW(),NOW()),
(1,11,'HP60P','Huawei P60 Pro','huawei-p60.jpg','Điện thoại Huawei','Chiếc',12,18000000,14,20520000,'visible',NOW(),NOW()),
(2,6,'TPX1','Lenovo ThinkPad X1 Carbon','thinkpadx1.jpg','Laptop doanh nhân','Chiếc',8,32000000,18,37760000,'visible',NOW(),NOW()),
(2,7,'HPSX360','HP Spectre x360','spectre360.jpg','Laptop cao cấp','Chiếc',9,29000000,17,33930000,'visible',NOW(),NOW()),
(2,4,'ROGG14','Asus ROG Zephyrus G14','rog-g14.jpg','Laptop gaming','Chiếc',6,35000000,20,42000000,'visible',NOW(),NOW()),
(2,8,'SWIFT3','Acer Swift 3','swift3.jpg','Laptop mỏng nhẹ','Chiếc',16,18000000,16,20880000,'visible',NOW(),NOW()),
(2,15,'MSIK15','MSI Katana 15','msi-katana.jpg','Laptop gaming','Chiếc',7,27000000,19,32130000,'visible',NOW(),NOW()),
(3,1,'IPADA5','iPad Air 5 64GB','ipadair5.jpg','Tablet Apple','Chiếc',18,14000000,15,16100000,'visible',NOW(),NOW()),
(3,2,'TAB9','Samsung Galaxy Tab S9','tabs9.jpg','Tablet Samsung','Chiếc',12,19000000,12,21280000,'visible',NOW(),NOW()),
(3,9,'MIPAD6','Xiaomi Pad 6','mipad6.jpg','Tablet Xiaomi','Chiếc',20,9000000,18,10620000,'visible',NOW(),NOW()),
(3,10,'SRF9','Microsoft Surface Pro 9','surfacepro9.jpg','Tablet 2-in-1','Chiếc',9,22000000,17,25740000,'visible',NOW(),NOW()),
(4,2,'GW6','Samsung Galaxy Watch 6','gw6.jpg','Smartwatch Samsung','Chiếc',24,6000000,15,6900000,'visible',NOW(),NOW()),
(4,11,'HWGT4','Huawei Watch GT 4','watchgt4.jpg','Smartwatch Huawei','Chiếc',20,4500000,20,5400000,'visible',NOW(),NOW()),
(4,1,'AWSE2','Apple Watch SE 2','awse2.jpg','Smartwatch Apple','Chiếc',18,5000000,15,5750000,'visible',NOW(),NOW()),
(4,9,'XMWS3','Xiaomi Watch S3','xiaomiwatchs3.jpg','Smartwatch Xiaomi','Chiếc',26,3500000,18,4130000,'visible',NOW(),NOW()),
(5,12,'JBLF6','JBL Flip 6','jblflip6.jpg','Loa bluetooth','Cái',30,3000000,25,3750000,'visible',NOW(),NOW()),
(5,13,'ANKP20','Anker PowerCore 20000','anker20000.jpg','Pin sạc dự phòng','Cái',40,800000,30,1040000,'visible',NOW(),NOW()),
(5,14,'MXM3S','Logitech MX Master 3S','mxmaster3s.jpg','Chuột không dây','Cái',25,1800000,22,2196000,'visible',NOW(),NOW()),
(5,5,'WF1000','Sony WF-1000XM5','sony-wf1000xm5.jpg','Tai nghe true wireless','Cái',20,5000000,20,6000000,'visible',NOW(),NOW()),
(5,13,'ANK65','Anker 65W GaN Charger','anker-65w.jpg','Sạc nhanh USB-C','Cái',35,600000,28,768000,'visible',NOW(),NOW()),
(5,14,'C920','Logitech C920 Pro HD','c920.jpg','Webcam Full HD','Cái',22,1200000,20,1440000,'visible',NOW(),NOW()),
(2,7,'HPENV14','HP Envy 14','hp-envy14.jpg','Laptop sang trong','Chiếc',11,24000000,16,27840000,'visible',NOW(),NOW()),
